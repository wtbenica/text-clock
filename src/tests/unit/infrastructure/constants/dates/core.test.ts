...
import { createDateConstants } from "../../../../../infrastructure/constants/dates/core.js";

import type { GettextFunctions } from "../../../../../infrastructure/utils/gettext/gettext_utils.js";
...
describe("createDateConstants", () => {
  ...
  describe("integration", () => {
    ...
    it("should maintain consistent translation contexts", () => {
      ...
      expect(contexts.some((ctx) => ctx.includes("Sunday the fifth"))).toBe(
        true,
      );
      expect(
        contexts.some((ctx) => ctx.includes("Saturday the eleventh")),
      ).toBe(true);
    });
  });
});
